...
•add_Num(int num) adds the integer num from the data stream to the data structure.
...
class MedianFinder:
    ...
    This gives direct access to the one or two middle values (they're the tops of the heaps), so getting the median
