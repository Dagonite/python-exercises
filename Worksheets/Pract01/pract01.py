...
def say_hello_world():
    """
    2. Write a function, say_hello_world(), that uses two print statements to display "Hello world".
    """
    print("Hello")
    print("world")
...
def euros_to_pounds():
    """
    3. Write a function, euros_to_pounds(), that converts an amount in Euros entered by the user to a corresponding
    amount in Pounds. Assume that the exchange rate is 1.15 Euros to the Pound.
    """
...
def add_up():
    """
    4. Write a functionn, add_up(), that asks the user to enter two numbers and outputs the sum.
    """
...
def change_counter():
    """
    5. Write a function, change_counter(), that asks the user how many 1p, 2p, and 5p coins they have (using three
...
def ten_hellos():
    """
    6. Write a function, ten_hellos(), that uses a loop to display "Hello world" ten times (on separate lines).
    """
    for _ in range(10):
        print("Hello world")
...
def count():
    """
    7. Write a function, count(), that instead of counting from 0 to 9, it counts up from 1 to 10. Hint: use a little
...
def future_value():
    """
    9. [harder] Write a function, future_value(), that uses a loop to calculate the future value of an investment
    amount, assuming an annual interest rate of 5.5%. The function should ask the user for the initial amount and the
    number of years that it is to be invested, and should output the final value of the investment using compound
