...
ISBN number, price, and the number of copies available. The number of copies can be assumed to be 0 upon creation of the 
object. Therefore, the parameters for the constructor should be title, author, number of pages, ISBN, and price 
__init__(self, title, author, no_pages, isbn, price). The class will require a number of methods to allow the bookshop 
to:
